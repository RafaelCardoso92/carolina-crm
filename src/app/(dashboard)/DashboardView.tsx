    ...
    <div className="space-y-4">
      ...
      {data.parcelasAtrasadas > 0 && (
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-3 flex items-center gap-3">
          ...
          <a href="/cobrancas" className="shrink-0 text-xs font-medium text-red-700 dark:text-red-300 hover:underline">
            Ver
          </a>
        </div>
      )}
      ...
      {premio ? (
        <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-2 mb-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-green-700 dark:text-green-300">Garantido</span>
            <span className="text-sm font-bold text-green-700 dark:text-green-300">{formatCurrency(premio.premio)}€</span>
          </div>
        </div>
      ) : (
