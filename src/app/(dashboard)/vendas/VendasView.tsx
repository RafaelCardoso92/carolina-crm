                    ...
                    {selectedClienteId && clientPurchaseHistory.neverPurchased.length > 0 && (
                      <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-4">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="text-sm font-bold text-amber-800 dark:text-amber-200">Sugestoes de Upsell</span>
                          <span className="text-xs text-amber-600 dark:text-amber-400">- Cliente nunca comprou:</span>
                        </div>
                        <div className="space-y-2">
                          {clientPurchaseHistory.neverPurchased.slice(0, 5).map((p) => (
                            <button
                              ...
                              className="w-full flex items-center justify-between gap-3 px-4 py-3 bg-white dark:bg-card border border-amber-300 dark:border-amber-700 rounded-xl text-left hover:bg-amber-100 dark:hover:bg-amber-900/40 hover:border-amber-400 transition group"
                              title={p.nome}
                            >
                              <span className="text-sm font-medium text-amber-900 dark:text-amber-100 truncate">{p.nome}</span>
                              <span className="flex-shrink-0 px-3 py-1 bg-amber-200 dark:bg-amber-800 text-amber-800 dark:text-amber-200 rounded-lg text-xs font-bold group-hover:bg-amber-300 dark:group-hover:bg-amber-700 transition">
                                + Adicionar
                              </span>
                            </button>
                          ))}
